...
configFieldTypeMaps[SINGLE_DATASET_CV_CONFIG_FILE_TYPE][YEAR_KEY]=np.int64
...
configFieldTypeMaps[TRAIN_TEST_DATASET_CONFIG_FILE_TYPE][TRAIN_DATASET_YEAR_KEY]=np.int64
configFieldTypeMaps[TRAIN_TEST_DATASET_CONFIG_FILE_TYPE][TRAIN_DATASET_CHAMBER_KEY]=str
configFieldTypeMaps[TRAIN_TEST_DATASET_CONFIG_FILE_TYPE][TEST_DATASET_YEAR_KEY]=np.int64
